     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="id_penerbit" placeholder="Id_penerbit"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Pengarang:</strong>
                <textarea class="form-control" style="height:150px" name="pengarang" placeholder="Pengarang"></textarea>
            </div>
        </div>
